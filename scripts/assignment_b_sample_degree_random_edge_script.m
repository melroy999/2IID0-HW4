...
for ratio = edge_removal_ratio
    ...
    file_code = [num2str(iterations) '_1_' num2str(1/ratio) '_' sign '_' num2str(round(cutoff))];
    ...
    xlabel(['Random runs with ' num2str(count) ' (' num2str(ratio) ' ratio) randomly removed edges']);
    ...
    suptitle(['Figures for degree random edge removal (ratio ' num2str(ratio) ', count ' num2str(count) ' ' sign ' ' num2str(cutoff) ')']);
